...
function getClassName({ className }) {
  return clsx(
    'text-white text-lg font-bold rounded-xl transition duration-300 curor-pointer focus:outline-none focus:ring-2 focus:ring-opacity-50',
    className
  )
}
...
export const Button = ({ children, className, size = 'small', variant = 'primary', ...rest }) => {
  return (
